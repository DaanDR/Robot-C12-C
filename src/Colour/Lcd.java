...
public class Lcd {
	...
	/**
	 * Clear LCD text line. Does not clear data written with System.out.println.
	 * 
	 * @param line
	 *            Line to clear, 1-based.
	 */
	...
	/**
	 * Clears specific characters in an LCD text line. Does not clear data written
	 * with System.out.println.
	 * 
	 * @param line
	 *            Line to clear, 1-based.
	 * @param col
	 *            Column to start clearing, 1-based.
	 * @param len
	 ...
	 *            Line to print on, 1-based.
	 * @param message
	 *            String to print with optional format specifiers for listed
	 *            parameters.
	 * @param parms
	 ...
	 *            Line to print on, 1-based
	 * @param col
	 *            Column to start printing on, 1-based.
	 * @param message
	 *            String to print.
	 */
