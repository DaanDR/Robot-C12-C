...
public class ColorSensor implements ColorDetector, ColorIdentifier {
	...
	/**
	 * Returns Color object with current detected color. Use with RGB mode and white
	 * light on target. Note that these values are the relative intensity of the
	 * reflected light of the primary colors. This is not the actual RGB value that
	 * would reproduce the color of the target surface.
	 * 
	 ...
	 * 
	 * @param on
	 *            True to turn floodlight on, false to turn off.
	 */
	 ...
	 * 
	 * @param color
	 *            Color id value from Color object.
	 */
