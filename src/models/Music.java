...
//		}
	...
	public void makeMusic() {
		...
		// run each program until escape button pressed.

		// Ambient program: measure light intensity
		// Flood light red.
		...
		// Red program: measure red intensity
		// Flood light red.
		while (Button.ESCAPE.isUp()) {
			Lcd.clear(5);
		...
		while (Button.ESCAPE.isUp()) {
			...
			if (kleur >= 4 && kleur <= 6) { // black
				...
				Sound.playTone(selectedScaleString[3], 350);
				Delay.msDelay(50);
			}
		...
		while (Button.ESCAPE.isUp()) {
			...
			case "Green":
				...
				break;
			case "Yellow":
				Sound.playTone(selectedScaleString[4], 350);
				break;
			case "White":
				Sound.playTone(selectedScaleString[5], 350);
				break;
			case "Brown":
				Sound.playTone(selectedScaleString[6], 350);
				break;
			}
