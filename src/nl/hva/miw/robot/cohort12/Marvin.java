...
public class Marvin { 
    ...
    public static void main(String[] args) {
    	...
    	/**
    	 * Task # 1: Follow line
    	 * Robot follows a black on white line parcours
...
//    	engineblock1.closeEngines();
    	...
    	/**
    	 * Task # 2: Drive With Music
    	 * Robot drives over strip of colors, playing a specific note for each color
    	 * Task # 3: Slay Monster
    	 * Robot finds and follows beacon, moves arm when close enough
    	 * If arm is moved 5 times, robot wins and does victory dance
    	 * Both tasks use the same engineblock.
    	 */
